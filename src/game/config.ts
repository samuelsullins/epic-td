...
export const TOWERS: Record<TowerKind, TowerDef> = {
  gun: {
    ...
    levels: [
      { cost: 70, hp: 240, range: 120, damage: 9, cooldown: 0.33 },
      { cost: 60, hp: 300, range: 130, damage: 14, cooldown: 0.3 },
      { cost: 110, hp: 360, range: 140, damage: 21, cooldown: 0.26 },
    ],
  },
  swarm: {
    ...
    levels: [
      { cost: 150, hp: 280, range: 170, damage: 11, cooldown: 2.4, volley: 6 },
      { cost: 110, hp: 340, range: 180, damage: 13, cooldown: 2.2, volley: 8 },
      { cost: 190, hp: 400, range: 195, damage: 16, cooldown: 2.0, volley: 10 },
    ],
  },
  arc: {
    ...
    levels: [
      { cost: 180, hp: 260, range: 135, damage: 16, cooldown: 1.5, chains: 3, chainRange: 95 },
      { cost: 140, hp: 320, range: 150, damage: 23, cooldown: 1.45, chains: 4, chainRange: 100 },
      { cost: 220, hp: 380, range: 165, damage: 32, cooldown: 1.4, chains: 5, chainRange: 110 },
    ],
  },
  railgun: {
    ...
    levels: [
      { cost: 170, hp: 260, range: 240, damage: 90, cooldown: 2.6 },
      { cost: 130, hp: 320, range: 255, damage: 140, cooldown: 2.4 },
      { cost: 220, hp: 380, range: 275, damage: 220, cooldown: 2.2 },
    ],
  },
  emp: {
    ...
    levels: [
      { cost: 130, hp: 260, range: 110, damage: 0, cooldown: 2.8, slowPct: 0.4, slowDur: 1.6 },
      { cost: 100, hp: 320, range: 122, damage: 0, cooldown: 2.6, slowPct: 0.5, slowDur: 2.0 },
      { cost: 170, hp: 380, range: 134, damage: 0, cooldown: 2.4, slowPct: 0.6, slowDur: 2.4 },
    ],
  },
  bertha: {
    ...
    levels: [
      { cost: 280, hp: 360, range: 260, damage: 120, cooldown: 5.0, splash: 80 },
      { cost: 210, hp: 430, range: 280, damage: 190, cooldown: 4.6, splash: 90 },
      { cost: 340, hp: 500, range: 300, damage: 290, cooldown: 4.2, splash: 100 },
    ],
  },
  hive: {
  ...
  ciws: {
    ...
    levels: [
      ...
      { cost: 170, hp: 420, range: 180, damage: 10, cooldown: 0.3, interceptPerSec: 8 },
    ],
  },
  bastion: {
